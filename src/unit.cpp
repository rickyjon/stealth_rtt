...
void Unit::_register_methods() {
	...
	register_method((char*)"find_path", &Unit::find_path);
	register_method((char *)"_process", &Unit::_process);
	register_method((char *)"_process", &Unit::_input);
...
/*
	...
	if (((InputEvent *)((Object *)event))->get_class() == "InputEventMouseButton") {
		InputEventMouseButton *iemb= (InputEventMouseButton *)((Object *)event); //TODO: rename *iemm to iem
